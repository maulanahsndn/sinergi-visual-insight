      ...
      case 'form':
        return (
          <InterviewForm
            ...
            editingData={editingInterview}
            onCancel={editingInterview ? handleCancelEdit : undefined}
          />
        );
      case 'dashboard':
        return (
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                <h1 className="text-xl font-poppins font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                  InterviewPro
                </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <Button
                ...
                className="bg-gradient-to-r from-primary to-accent hover:from-primary-glow hover:to-accent neon-glow hover-lift text-white px-8 py-6 text-lg font-semibold rounded-lg"
              >
