...
const Index = () => {
  ...
  // Initialize loading and dummy data
  useEffect(() => {
          ...
          duration: 0.5
            ...
            {currentView === 'hero' && <section id="features" className="py-20 px-6">
              ...
              duration: 0.8
                    ...
                    <h2 className="text-4xl font-orbitron font-bold mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent tracking-wider">
                      FITUR UNGGULAN 2025
                    </h2>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto font-space-grotesk leading-relaxed">
                      Sistem manajemen interview yang lengkap dengan teknologi canggih dan AI assistant masa depan
                    </p>
                  </motion.div>
                ...
                delay: index * 0.2
                        ...
                        <Card className="glass-card border-glass-border/50 h-full hover-lift group">
                          <CardContent className="p-8 text-center">
                            ...
                            <h3 className="text-xl font-orbitron font-semibold mb-4 text-foreground tracking-wider">
                              {feature.title}
                            </h3>
                            <p className="text-muted-foreground leading-relaxed font-space-grotesk">
                              {feature.description}
                            </p>
                          </CardContent>
                        </Card>
              ...
              delay: 0.8
                    ...
                    <Button onClick={() => setCurrentView('form')} className="bg-gradient-to-r from-primary to-accent hover:from-primary-glow hover:to-accent neon-glow hover-lift text-white px-8 py-6 text-lg font-semibold rounded-lg font-space-grotesk tracking-wider">
            ...
            <footer className="glass-card border-t border-glass-border/50 py-8 px-6 mt-20">
              <div className="max-w-7xl mx-auto text-center">
                <p className="text-muted-foreground mb-4 font-space-grotesk tracking-wide">
                  © 2025 Interview Management System. Created by <span className="text-primary font-bold">MaulanaHsndnn</span> | Powered by AI & Future Technology.
                </p>
              </div>
            </footer>
          </div>
