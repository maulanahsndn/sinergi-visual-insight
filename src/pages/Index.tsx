                ...
                <div className="max-w-6xl mx-auto">
                  ...
                  <motion.div initial={{
                    ...
                    <Button 
                      ...
                      className="bg-gradient-to-r from-primary to-accent hover:from-primary-glow hover:to-accent neon-glow hover-lift text-white px-8 py-6 text-lg font-semibold rounded-lg font-space-grotesk tracking-wider"
                    >
